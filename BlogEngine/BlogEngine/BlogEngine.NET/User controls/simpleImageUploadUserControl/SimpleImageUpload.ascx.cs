    ...
    : System.Web.UI.UserControl, IPostBackDataHandler 
{
    ...
    protected string _Text_EditButton = "Bewerken...";
    /// <summary>
    ...
    protected string _Text_RemoveButton = "Verwijderen";
    /// <summary>
    ...
    protected string _Text_BrowseButton = "Bladeren...";
    /// <summary>
    ...
    protected string _Text_CancelUploadButton = "Upload annuleren";
    /// <summary>
    ...
    protected string _Text_ConfigurationLabel = "Instellingen:";
    /// <summary>
    ...
    protected string _StatusMessage_NoImageSelected = "Geen afbeelding geselecteerd";
    /// <summary>
    ...
    protected string _StatusMessage_UploadError = "<span style=\"color:#cc0000;\">De afbeelding moet kleiner zijn dan {0} KBytes.</span>";
    /// <summary>
    ...
    protected string _StatusMessage_InvalidImage = "<span style=\"color:#cc0000;\">Het bestand is geen geldige afbeelding</span>";
    /// <summary>
    ...
    protected string _StatusMessage_InvalidImageSize = "<span style=\"color:#cc0000;\">De afbeelding is niet gelding (te groet of te klein).</span>";
    /// <summary>
    ...
    protected string _StatusMessage_Wait = "<span style=\"color:#aaaaaa;\">Wacht ff jong!...</span>";
    /// <summary>
