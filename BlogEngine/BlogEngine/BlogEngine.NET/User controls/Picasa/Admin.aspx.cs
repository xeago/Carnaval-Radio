...
public partial class User_controls_PicasaSlideShow_Admin : System.Web.UI.Page
{
    ...
    protected string GetHeader()
    {
        ...
        sb.Append(string.Format(head, "Title"));
        sb.Append(string.Format(head, "Description"));
        sb.Append(string.Format(head, "Photos"));
        sb.Append(string.Format(head, "Access"));
