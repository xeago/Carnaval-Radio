...
<% if (CommentCounter > 0)
   { %>
<h3 id="comment">
    <%=Resources.labels.messages %> (<%=CommentCounter%>)
...
<div id="comment-form">
	...
	<div class="commentForm">
	  <h3 id="addcomment"><%=Resources.labels.addGuestbookMessage %></h3>
      ...
      <p>
	    <input type="button" id="btnSaveAjax" class="btn-save" style="margin-top:10px" value="<%=Resources.labels.saveMessage %>" onclick="return BlogEngine.validateAndSubmitCommentForm()" tabindex="10" />
