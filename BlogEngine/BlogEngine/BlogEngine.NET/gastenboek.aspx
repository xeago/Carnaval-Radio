            ...
            <div style="width: 455px">
                    <div>
                        <div style="width: 195px">
                            <asp:Label ID="lblyourname" runat="server" Font-Bold="True">Naam</asp:Label></div>
                        <div style="width: 315px" align="left"><asp:TextBox ID="yourname" runat="server" Width="310px"></asp:TextBox></div>
                    </div>
                    <div>
                        <div style="width: 195px">
                            <asp:Label ID="lblyouremail" runat="server" Font-Bold="True">Email</asp:Label></div>
                        <div style="width: 315px" align="left"><asp:TextBox ID="youremail" runat="server" Width="310px"></asp:TextBox></div>
                    </div>
                    <div>
                        <div style="width: 195px">
                            <asp:Label ID="lblyourmessage" runat="server" Font-Bold="True">Bericht</asp:Label></div>
                    ...
                    <div>
                        <div colspan="2" align="right" style="height: 22px">
                            <asp:Button ID="btnAdd" runat="server" Height="20px" Text="Verzenden" 
